 ...
 * The group 2 Dih(5)
 */
public class DoubleDih5 extends AbstractCombinatorialGroup {
    ...
    public Realization generateRealization(int degree, Perm g5i, Perm g2) {
        Realization rel = new Realization(this, degree);
        Perm i = g5i.pow(5);
        rel.setGenerator(Generator.G5I, g5i);
        rel.setGenerator(Generator.G5, g5i.mul(i));
    ...
    public Iterable<PointGroup3D> getPointGroups() {
        return Arrays.asList(PointGroup3D.D5d, PointGroup3D.D5dstar);
    }
